 ...
 */
/*
Plugin Name: Suntech_pay24紅陽超商代收
  ...
  public function init_from_fields(){
    $this->form_fields = array(
                        'enabled' => array(
                                ...
                                'type'    => 'checkbox',
                                'label'   => __( '啟用紅陽超商代收', 'woocommerce' ),
                                'default' => 'yes'
                        ),
                        'title' => array(
                                'title'       => __( '顯示名稱', 'woocommerce' ),
                                'type'        => 'text',
                                'default'     => __( '紅陽超商代收', 'woocommerce' ),
                                'desc_tip'    => true,
                        ),
                        'description' => array(
                                ...
                                'default'     => __( '進入紅陽超商代收流程', 'woocommerce' )
                        ),
...
update_option($opt_name, serialize(array(
  'DueDate'=>$_DueDate,'UserNo'=>$_UserNo,'str_input_product'=>$_str_inputs_product,
