 ...
 */
/*
Plugin Name: Suntech_buysafecardtype1紅陽銀聯
...
class WC_Gateway_Suntech_Buysafecardtype1 extends WC_Gateway_Suntech_Base{

  public function __construct() {
    $this->id = 'suntech_buysafecardtype1';
  ...
  public function init_from_fields(){
    ...
    $this->form_fields = array(
                        'enabled' => array(
                                ...
                                'type'    => 'checkbox',
                                'label'   => __( '啟用紅陽銀聯', 'woocommerce' ),
                                'default' => 'yes'
                        ),
                        'title' => array(
                                'title'       => __( '顯示名稱', 'woocommerce' ),
                                'type'        => 'text',
                                'default'     => __( '紅陽銀聯', 'woocommerce' ),
                                'desc_tip'    => true,
                        ),
                        'description' => array(
                                ...
                                'default'     => __( '進入紅陽銀聯流程', 'woocommerce' )
                        ),
...
$_note1 = self::get_note1('buysafecardtype1',$order,'billing_email');
...
function add_woocommerce_suntechbuysafecardtype1_gateway($methods) {
  $methods[] = 'WC_Gateway_Suntech_Buysafecardtype1';
  return $methods;
} 
add_filter('woocommerce_payment_gateways', 'add_woocommerce_suntechbuysafecardtype1_gateway');
